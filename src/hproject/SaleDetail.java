 ...
 * @author GuHeHe
 */
public class SaleDetail extends javax.swing.JDialog {

    /**
     * Creates new form SaleDetail
     */
    private static String saleid, datetime;
    ...
    public SaleDetail(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        createtable();
        System.out.println(saleid+"YYYYYYYYYYYYYYYYYYYY");
        str="SELECT * FROM saledetail where saleid='"+saleid+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaleDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SaleDetail dialog = new SaleDetail(new javax.swing.JFrame(), true);
