 ...
 * @author GuHeHe
 */
public class PromotionTypeEntry extends javax.swing.JDialog {

    /**
     * Creates new form PromotionType
     */
    mySQLQueries msql=new mySQLQueries();
    public PromotionTypeEntry(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        AutoID();
    ...
    public void AutoID()
    {
        lblid.setText((String.valueOf(msql.getAutoid("ptid","promotiontype","PT-"))));
    }
    public void clear()
    {
        txtname.setText("");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Promotion Type Info :"));

        jLabel1.setText("Promotion Type ID      :");

        jLabel2.setText("Promotion Type Name :");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(Checking.IsNull(txtname.getText()))
        {
            ...
            boolean ee = msql.isduplicate("promotiontype", st);
            if(!ee)
            {
            ...
            else
            {
                ...
                str[0]= lblid.getText();
                boolean save = msql.insertData("promotiontype", str);
                if(save)
                {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PromotionTypeEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PromotionTypeEntry dialog = new PromotionTypeEntry(new javax.swing.JFrame(), true);
