 ...
 * @author GuHeHe
 */
public class BrandSearch extends javax.swing.JDialog {

    /**
     * Creates new form BrandSearch
     */
    mySQLQueries msql = new mySQLQueries();
    DefaultTableModel dtm = new DefaultTableModel();
    Statement ste = null ;
    Connection con = null;
    public BrandSearch(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try
        {
    ...
    private void initComponents() {
        ...
        setTitle("Brand Search");
        setLocation(new java.awt.Point(600, 250));

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Brand Search :"));
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        if (!txtname.getText().equals(null)){
            String str = "select * from brand where brandname = '"+txtname.getText()+"'";
            fillBrData(str);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrandSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BrandSearch dialog = new BrandSearch(new javax.swing.JFrame(), true);
