 ...
 * @author GuHeHe
 */
public class PromoGift extends javax.swing.JDialog {

    /**
     * Creates new form PromoGift
     */
    ...
    String strquery01[];
    public PromoGift(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        createtable();
        filltable();
    ...
    public void fillItem(String sql)
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                strdataitem[3]=rs.getString(3);//qty
...
//        lblitemtype.setText(strdataitem[3]);
    ...
    public void showitem01()
    {
        strquery = msql.getItemData1(txtgid.getText());
        strdataitem[1]=strquery[0];//itemid
        strdataitem[2]=strquery[1];//itemname
        txtgitemname.setText(strdataitem[2]);
//        lblitemtype.setText(strdataitem[3]);
    }
    ...
    private void initComponents() {
        ...
        txtgitemname = new javax.swing.JTextField();
        txtgquantity = new javax.swing.JTextField();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Gift Item Info :"));

        jLabel11.setText("Item Name :");

        jLabel1.setText("Gift Item Code : ");

        txtgid.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtgidKeyPressed(evt);
            }
        });

        jLabel2.setText("Gift Quantity: ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtgid)
                    .addComponent(txtgitemname, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(43, 43, 43)
                .addComponent(jLabel2)
                .addGap(27, 27, 27)
                .addComponent(txtgquantity, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txtgquantity, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel2)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel11)
                    .addComponent(txtgitemname, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        else
        {
            if(JOptionPane.showConfirmDialog(null, "Are you sure to Save ?","Confirm",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE)==JOptionPane.YES_OPTION)
            {
                ...
                for(int i=0 ; i<vidsize ; i++) {
                    ...
                    savedata2[3]=txtgid.getText();//gift id
                    savedata2[4]=txtgitemname.getText();// gift name
                    savedata2[5]=txtgquantity.getText();// gift qty
                    save=msql.insertData("temppro02", savedata2);
                }
    ...
    private void txtgidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtgidKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            // System.out.println("Right key typed");
            showitem01();
            txtgquantity.setText("1");
            txtgquantity.requestFocus();
            //   getRootPane().setDefaultButton(btnupdate);
        }
    }//GEN-LAST:event_txtgidKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PromoGift.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PromoGift dialog = new PromoGift(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField txtgitemname;
    private javax.swing.JTextField txtgquantity;
